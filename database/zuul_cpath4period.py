...
class Runner(object):
    ...
    def get_parser(self):
        ...
        parser.add_argument('-t', '--starttime', dest='starttime', help="endtime")
        parser.add_argument('-e', '--endtime', dest='endtime', help="endtime")
    ...
    def run(self):
        ...
        if not self.jto_args.starttime or not self.jto_args.endtime:
            raise RuntimeError("starttime and endtime is manatory !!!")
